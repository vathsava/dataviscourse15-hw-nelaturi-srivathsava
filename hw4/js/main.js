...
(function () {
    ...
    function initVis() {
     ...
     //   var eventHandler = {};
        ...
        selectionChanged=function(startRange,endRange){
          ageVis.onSelectionChange(startRange,endRange);
            prioVis.onSelectionChange(startRange,endRange);
            countVis.onSelectionChange(startRange,endRange);
